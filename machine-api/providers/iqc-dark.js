...
const txt = `Earth without art is just "eh" 🌍🎨✨`
const timeStr = "16.34"
const imgUrl = "https://o.uguu.se/hsPAeTrD.webp"
...
async function main() {
    try {
        ...
        const rinOut = join(process.cwd(), `rinchat-${Date.now()}.png`);
...
module.exports = { downloadFile, emojiToUnicode, loadAppleEmojiMap, getEmojiImage, drawAppleEmoji, measureTextCustom, drawTextWithEmojis, wrapText, main };
